...
// Settings for LCD Command Entry (Needed?)
...
// Setting for LCD CD Shift (Shift CUrsor or Display without changing DDRAM data)
...
#define LCD_BUS_BIT			(0xF << 8)  //PA8, 9, 10, and 11
#define	LCD_BUS_BIT_POS	8

#define LCD_PORT_BITS		(LCD_RS_BIT | LCD_E_BIT | LCD_BUS_BIT)  //0x07E0  // bit 6, 7, 8, 9, 10, and 11
